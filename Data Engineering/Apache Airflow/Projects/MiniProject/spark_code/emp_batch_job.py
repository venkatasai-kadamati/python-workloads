...
def process_data():
    ...
    bucket = "airflow-projects-gdsk"
    emp_data_path = f"gs://{bucket}/airflow-project-mini/data/employee.csv"
    dept_data_path = f"gs://{bucket}/airflow-project-mini/data/department.csv"
    output_path = f"gs://{bucket}/airflow-project-mini/output"
    ...
    filtered_employee = employee.filter(
        employee.salary > 50000
    )  # Adjust the salary threshold as needed
