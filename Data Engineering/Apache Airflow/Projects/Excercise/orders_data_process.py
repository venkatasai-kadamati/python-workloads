...
def main(date):
    ...
    input_path = (
        f"gs://airflow-projects-gdsk/airflow-project-excercise/data/orders_{date}.csv"
    )
    ...
    output_path = f"gs://airflow-projects-gds/airflow-project-excercise/output/processed_orders_{date}"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--date", type=str, required=True, help="Date in yyyymmdd format"
    )
